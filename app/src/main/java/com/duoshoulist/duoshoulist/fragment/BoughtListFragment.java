...
import com.duoshoulist.duoshoulist.activity.MainActivity;
...
public class BoughtListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        coordinatorLayout = (CoordinatorLayout) inflater.inflate(R.layout.fragment_list,container,false);
//        swipeRefreshLayout = (SwipeRefreshLayout) inflater.inflate(R.layout.fragment_selected, container, false);

//        MainActivity.coordinatorLayout.setOnTouchListener(new View.OnTouchListener() {
//            @Override
...
//            }
//        });
//        MainFragment.coordinatorLayout.setOnTouchListener(new View.OnTouchListener() {
//            @Override
//            public boolean onTouch(View v, MotionEvent event) {
//                v.getParent().requestDisallowInterceptTouchEvent(true);
//                return false;
...
//        });
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        swipeRefreshLayout = (SwipeRefreshLayout) getView().findViewById(R.id.fragment_selected_swipeRefreshLayout);
